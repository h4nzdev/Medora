...
// Import your AdminCharts component
import AdminCharts from "./AdminCharts"; // Make sure this path is correct
...
const AdminDashboard = () => {
  ...
  const [view, setView] = useState("default"); // Add this state for view toggle
  ...
  // YOUR EXACT SAME UI FROM BEFORE - JUST WITH VIEW TOGGLE! 🎯
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="mx-auto">
        {/* Header - Same as before BUT WITH VIEW TOGGLE BUTTONS */}
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
            ...
            <div className="flex items-center gap-4">
              {/* View Toggle Buttons */}
              <div className="bg-white rounded-xl p-1 shadow-lg border border-slate-200 flex">
                <button
        ...
        {/* CONDITIONAL RENDERING - Show charts or default view */}
        {view === "charts" ? (
          <AdminCharts />
        ) : (
          <>
